...
task2(6, 4, 5)
task2(14, 2, 7)
console.log(capitalizeIt("help me pls"))



/*Создать html-страницу с инпутом и кнопкой.
 По нажатию на кнопку выводить текст из инпута в блок div ниже на странице.*/
const m = document.getElementById("228")
const button = document.getElementById("1337")
button.addEventListener("click",()=>{
    document.getElementById("1488").innerText = m.value
})
